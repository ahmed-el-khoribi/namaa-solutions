...
<div class="card-body">
    ...
    {!! Form::model($article, ['method' => 'PATCH','route' => ['portal.articles.update', $article->id], 'files' => true]) !!}
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Author:</strong>
                {!! Form::select('author_id', $users, $article->author_id, array('class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
